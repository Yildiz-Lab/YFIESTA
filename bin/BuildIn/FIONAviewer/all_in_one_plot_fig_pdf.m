...
for i = 1:length(fnames)
    ...
    plot(time2-time2(1), ch2trace+offset,'Color','blue','LineWidth',1.)
    ...
    plot(time2-time2(1), ch2trace_yx,'Color',[0 0 0.7],'LineWidth',1.)
    plot(time2-time2(1), ch2data.trace_yx(idx2,3),'m','LineWidth',2)
    
    % blue fit with more transparent blue data
    % plot(time2-time2(1), ch2data.trace(idx2,1)+offset,'Color',[0 0 1 0.45],'LineWidth',0.4)
    % plot(time2-time2(1), ch2data.trace(idx2,3)+offset,'blue','LineWidth',2)
    % 
    % plot(time2-time2(1), ch2data.trace_yx(idx2,1),'Color',[0 0 0.7 0.45],'LineWidth',0.4)
    % plot(time2-time2(1), ch2data.trace_yx(idx2,3),'blue','LineWidth',2)
    ...
    if contains(fname,'nbh')
        ...
        % try
            ...
            plot(time1-time2(1), ch1trace+offset+dx,'Color',[0 0.7 0],'LineWidth',1.)
            ...
            plot(time1-time2(1), ch1trace_yx+dy,'Color',[0 0.4 0],'LineWidth',1.)
            plot(time1-time2(1), ch1data.trace_yx(idx1,3)+dy,'k','LineWidth',2)

            % % green data slightly transparent with green line fit
            % plot(time1-time2(1), ch1data.trace(idx1,1)+offset+dx,'Color',[0 0.7 0 0.45],'LineWidth',0.4)
            % plot(time1-time2(1), ch1data.trace(idx1,3)+offset+dx,'Color',[0 0.7 0],'LineWidth',2)
            % 
            % plot(time1-time2(1), ch1data.trace_yx(idx1,1)+dy,'Color',[0 0.4 0 0.45],'LineWidth',0.4)
            % plot(time1-time2(1), ch1data.trace_yx(idx1,3)+dy,'Color',[0 0.4 0],'LineWidth',2)
