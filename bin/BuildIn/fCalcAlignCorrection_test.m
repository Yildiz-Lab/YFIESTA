...
% % end
% 
% ch1file = '/Volumes/TOSHIBA EXT/MINFLUX JS/241109/241109-092420_minflux_large_centered_fiesta.mat';
% ch2file = '/Volumes/TOSHIBA EXT/MINFLUX JS/241109/241109-092420_minflux_large_centered_fiesta.mat';
% 
% ch1data = load(ch1file);
% ch2data = load(ch2file);
% 
% % JS Edit 2024/11/10 for MINFLUX data which already loads as molecules and
...
%             % fprintf("Channel 1: " +num2str(s) + "\n")
%         elseif ch1data.Molecule(s).Channel == 2
%             ch2cnt = ch2cnt + 1;
%             % ch2data.Objects{1} = struct();
%             ch2data.Objects{1}.center_x(ch2cnt) = mean(ch1data.Molecule(s).Results(:,3));
%             ch2data.Objects{1}.center_y(ch2cnt) = mean(ch1data.Molecule(s).Results(:,4));
%             % fprintf("Channel 2: " +num2str(s) + "\n")
%         end
% 
% 
%     end
% 
%     % ch1data.Objects{1}.center_x
%     % ch2data.Objects{1}.center_x
% 
%     % if they are actually different files, so then we should separate.
%     if ~strcmp(ch1file, ch2file)
%         ch2data.Objects = {};
%         ch2cnt = 0;
%         for s = 1:length(ch2data.Molecule)
%             ch2cnt = ch2cnt + 1;
%             ch2data.Objects{ch2cnt} = struct();
%             ch2data.Objects{ch2cnt}.center_x(ch2cnt) = mean(ch2data.Molecule(s).Results(:,3));
%             ch2data.Objects{ch2cnt}.center_y(ch2cnt) = mean(ch2data.Molecule(s).Results(:,4));
%         end
%     end
% 
% 
...
ch1file = '/Users/slivka/Documents/MATLAB/241109-092420_minflux_large_centered_fiesta.mat';
ch2file = '/Users/slivka/Documents/MATLAB/241109-092420_minflux_large_centered_fiesta.mat';
