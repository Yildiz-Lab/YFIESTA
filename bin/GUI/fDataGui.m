...
if isempty(h)
    ...
    hDataGui.cCorrection = uicontrol('Parent',hDataGui.fig,'Units','normalized','Callback','fDataGui(''Correction'',getappdata(0,''hDataGui''));',...
                                'Position',[0.02 0.855 0.12 0.02],'String','Apply corrections','Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Tag','cCorrection','Value',Object.Drift);
    ...
    hDataGui.rBlue = uicontrol('Parent',hDataGui.gColor,'Units','normalized','Position',[0.025 0.75 0.4 0.25],...
                               'String','Blue','Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Tag','rBlue','UserData',[0 0 1]);

    hDataGui.rGreen = uicontrol('Parent',hDataGui.gColor,'Units','normalized','Position',[0.025 0.5 0.4 0.25],...
                                'String','Green','Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Tag','rGreen','UserData',[0 1 0]);

    hDataGui.rRed = uicontrol('Parent',hDataGui.gColor,'Units','normalized','Position',[0.025 0.25 0.4 0.25],...
                              'String','Red','Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Tag','rRed','UserData',[1 0 0]);

    hDataGui.rMagenta = uicontrol('Parent',hDataGui.gColor,'Units','normalized','Position',[0.475 0.75 0.5 0.25],...
                               'String','Magenta','Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Tag','rMagenta','UserData',[1 0 1]);

    hDataGui.rCyan = uicontrol('Parent',hDataGui.gColor,'Units','normalized','Position',[0.475 0.5 0.5 0.25],...
                                  'String','Cyan','Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Tag','rCyan','UserData',[0 1 1]);

    hDataGui.rPink = uicontrol('Parent',hDataGui.gColor,'Units','normalized','Position',[0.475 0.25 0.5 0.25],...
                                 'String','Pink','Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Tag','rPink ','UserData',[1 0.5 0.5]);
    
    % JS Edit 2025/09/21 for time dependent coloring
    hDataGui.rCMap = uicontrol('Parent',hDataGui.gColor,'Units','normalized','Position',[0.025 0. 0.5 0.25],...
                                 'String','Time Cmap','Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Tag','rCMap','UserData',[1 0.5 0.5]);
