...
hNeighborRegion.tRegion(1) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.2 0.825 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','Region 1','Style','text','Tag','tXB','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                 

hNeighborRegion.tRegion(2) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.35 0.825 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','Region 2','Style','text','Tag','tXB','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);  
               
hNeighborRegion.tRegion(3) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.5 0.825 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','Region 3','Style','text','Tag','tXB','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                 

hNeighborRegion.tRegion(4) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.65 0.825 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','Region 4','Style','text','Tag','tXB','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);  

hNeighborRegion.tRegion(5) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.8 0.825 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','Region 5','Style','text','Tag','tXB','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);  
                             

                             Z = prevopts.XB;
hNeighborRegion.tXB = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.06 0.75 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','X Before','Style','text','Tag','tXB','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                 
                            
hNeighborRegion.eXB(1) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.2 0.765 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 1),'Style','edit','Tag','eXB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                            
hNeighborRegion.eXB(2) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.35 0.765 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 2),'Style','edit','Tag','eXB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                                                
hNeighborRegion.eXB(3) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.5 0.765 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 3),'Style','edit','Tag','eXB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext); 

hNeighborRegion.eXB(4) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.65 0.765 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 4),'Style','edit','Tag','eXB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   

hNeighborRegion.eXB(5) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.8 0.765 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 5),'Style','edit','Tag','eXB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   

                            Z = prevopts.XA;
hNeighborRegion.tXA = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.06 0.625 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','X After','Style','text','Tag','tXA','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                 
                            
hNeighborRegion.eXA(1) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.2 0.64 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 1),'Style','edit','Tag','eXA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                            
hNeighborRegion.eXA(2) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.35 0.64 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 2),'Style','edit','Tag','eXA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                                                
hNeighborRegion.eXA(3) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.5 0.64 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 3),'Style','edit','Tag','eXA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext); 

hNeighborRegion.eXA(4) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.65 0.64 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 4),'Style','edit','Tag','eXA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   

hNeighborRegion.eXA(5) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.8 0.64 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 5),'Style','edit','Tag','eXA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   

                            Z = prevopts.YB;
hNeighborRegion.tYB = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.06 0.505 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','Y Left','Style','text','Tag','tYB','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                 
                            
hNeighborRegion.eYB(1) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.2 0.515 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 1),'Style','edit','Tag','eYB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                            
hNeighborRegion.eYB(2) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.35 0.515 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 2),'Style','edit','Tag','eYB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                                                
hNeighborRegion.eYB(3) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.5 0.515 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 3),'Style','edit','Tag','eYB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext); 

hNeighborRegion.eYB(4) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.65 0.515 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 4),'Style','edit','Tag','eYB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   

hNeighborRegion.eYB(5) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.8 0.515 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 5),'Style','edit','Tag','eYB','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);  
                            

                            Z = prevopts.YA;
hNeighborRegion.tYA = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.06 0.38 0.12 0.08],'Enable','on','FontSize',12,...
                                 'String','Y Right','Style','text','Tag','tYA','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                 
                            
hNeighborRegion.eYA(1) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.2 0.39 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 1),'Style','edit','Tag','eYA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                            
hNeighborRegion.eYA(2) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.35 0.39 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 2),'Style','edit','Tag','eYA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
                                                
hNeighborRegion.eYA(3) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.5 0.39 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 3),'Style','edit','Tag','eYA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext); 

hNeighborRegion.eYA(4) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.65 0.39 0.12 0.08],'Enable','on','FontSize',12,...
                                'String',UnpackageRegions(Z, 4),'Style','edit','Tag','eYA','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   

hNeighborRegion.eYA(5) = uicontrol('Parent',hNeighborRegion.fig,'Units','normalized','Position',[0.8 0.39 0.12 0.08],'Enable','on','FontSize',12,...
