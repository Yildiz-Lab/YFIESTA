...
%     case 'SegLineRegion' % JS Edit
%         ToolSegLineRegion(varargin{1});
    case 'NormImage'
...
% set(hMainGui.ToolBar.ToolSegLineRegion,'State','off'); % JS Edit 2022/06/29
...
% JS Edit 2022/06/29
% function ToolSegLineRegion(hMainGui)
% global Stack;
% if ~isempty(Stack)
%     set(hMainGui.ToolBar.ToolCursor,'State','off');
%     set(hMainGui.ToolBar.ToolRegion,'State','off');
%     set(hMainGui.ToolBar.ToolRectRegion,'State','off');
%     set(hMainGui.ToolBar.ToolSegLineRegion,'State','on');
%     hMainGui.Values.CursorDownPos(:)=0;
%     hMainGui.CursorMode='SegLineRegion';
%     setappdata(0,'hMainGui',hMainGui);
%     fRightPanel('AllToolsOff',hMainGui);
%     hMainGui=getappdata(0,'hMainGui');
%     SetZoom(hMainGui);
% else
%     set(hMainGui.ToolBar.ToolSegLineRegion,'State','off');
% end
