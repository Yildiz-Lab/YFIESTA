...
hMidPanel.pFrame = uipanel('Parent',hMainGui.fig,'Units','normalized','Bordertype','line',...
...
hMidPanel.pInfo = uipanel('Parent',hMainGui.fig,'Units','normalized','Bordertype','line',...
