...
switch func
    ...
    case 'ExportScanRegion'
        RegionExportScan(varargin{1});  
    case 'ExportKymo'
...
% JS Edit 2022/07/11
function RegionExportScan(hMainGui)
global Stack;

nRegion=length(hMainGui.Region);
hMainGui.Region(nRegion+1).X=[hMainGui.Scan.lx, fliplr(hMainGui.Scan.ux), hMainGui.Scan.lx(1)];
hMainGui.Region(nRegion+1).Y=[hMainGui.Scan.ly, fliplr(hMainGui.Scan.uy), hMainGui.Scan.ly(1)];
hMainGui.Plots.Region(nRegion+1)=line(hMainGui.MidPanel.aView,[hMainGui.Scan.lx, fliplr(hMainGui.Scan.ux), hMainGui.Scan.lx(1)], [hMainGui.Scan.ly, fliplr(hMainGui.Scan.uy), hMainGui.Scan.ly(1)],'Color','white','LineStyle','--');
...
hMainGui.Region(nRegion).ScanData.X = hMainGui.Scan.X;
hMainGui.Region(nRegion).ScanData.Y = hMainGui.Scan.Y;
hMainGui.Region(nRegion).ScanData.ScanSize = hMainGui.Values.ScanSize;
hMainGui.Region(nRegion).ScanData.MeasureLength = hMainGui.Scan.InterpD;
...
set(hMainGui.RightPanel.pTools.bLineScanExportRegion,'Enable','on'); % JS Edit 2022/07/11
