...
hConfigGui.pGeneral.panel = uipanel('Parent',hConfigGui.fig,'Units','normalized','Fontsize',12,'Bordertype','none',...
                                    'Position',[0 0.6 1 0.4],'Tag','pGeneral','Visible','on','BackgroundColor',c,'ForegroundColor',ctext);          
...
hConfigGui.pGeneral.tStackT = uicontrol('Parent',hConfigGui.pGeneral.panel,'Style','text','Units','normalized',...
                                                ...
                                                'String','Stack:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);     
...
hConfigGui.pGeneral.tStack = uicontrol('Parent',hConfigGui.pGeneral.panel,'Style','text','Units','normalized',...
                                                ...
                                                'String',Config.StackName{n-1},'HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);     
...
hConfigGui.pGeneral.tStackTypeT = uicontrol('Parent',hConfigGui.pGeneral.panel,'Style','text','Units','normalized',...
                                                ...
                                                'String','StackType:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);     
...
hConfigGui.pGeneral.tStackType = uicontrol('Parent',hConfigGui.pGeneral.panel,'Style','text','Units','normalized',...
                                           ...
                                           'String',Config.StackType{n-1},'HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                      

hConfigGui.pGeneral.pOptions = uipanel('Parent',hConfigGui.pGeneral.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pGeneral.tPixSize = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','text','Units','normalized',...
                                         ...
                                         'String','Pixel size:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);     
                                     
hConfigGui.pGeneral.ePixSize = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','edit','Units','normalized',...
                                         'Position',[.175 .55 .075 .4],'Tag','ePixSize','Fontsize',10,'UserData','Pixel_size',...
                                         'String',num2str(Config.PixSize),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
...
hConfigGui.pGeneral.tNM(1) = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','text','Units','normalized',...
                                    'Position',[.26 .45 .04  .4],'Tag','tNM','Fontsize',12,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pGeneral.tTimeDiff = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','text','Units','normalized',...
                                         ...
                                         'String','Time difference:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             
...
hConfigGui.pGeneral.eTimeDiff = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','edit','Units','normalized',...
                                         ...
                                         'String','','BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Time_difference');                             
...
hConfigGui.pGeneral.tMS = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','text','Units','normalized',...
                                    ...
                                    'String','ms','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);    
                                
if Config.Time(n-1) > 0 
...
elseif Config.Time(n-1) < 0
    set(hConfigGui.pGeneral.eTimeDiff,'String',num2str(abs(Config.Time(n-1))),'Enable','inactive');
    set(hConfigGui.pGeneral.tTimeDiff,'Enable','on');
    set(hConfigGui.pGeneral.tMS,'Enable','on');
end
...
hConfigGui.pGeneral.tFirstFrame = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','text','Units','normalized',...
                                         ...
                                         'String','First Frame:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             
...
hConfigGui.pGeneral.eFirstFrame = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.FirstTFrame),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','First.2Last_Frame');                                               
...
hConfigGui.pGeneral.tLastFrame = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','text','Units','normalized',...
                                           ...
                                           'String','Last Frame:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             
...
hConfigGui.pGeneral.eLastFrame = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.LastFrame),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Frame');                             
                                     
hConfigGui.pGeneral.cParallelProcessing = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized','Value',0,...
                                         'Callback','fConfigGui(''ParallelProcessing'',getappdata(0,''hConfigGui''));','Position',[.65 .525 .15 .4],'String','Parallel Processing:','Fontsize',12,'Tag','cParallelProcessing','HorizontalAlignment','left',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Parallel_processing');  

hConfigGui.pGeneral.eNumCores = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','edit','Units','normalized',...
                                         'Position',[.82 .525 .15 .4],'Tag','eNumCores','Fontsize',10,'Enable','off',...
                                         'String','','BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Parallel_processing');

 if ~isempty(Config.NumCores) && Config.NumCores>0
    set(hConfigGui.pGeneral.cParallelProcessing,'Value',1);
    set(hConfigGui.pGeneral.eNumCores,'String',num2str(Config.NumCores),'Enable','on');
 end

hConfigGui.pGeneral.cUseServer = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                         'Callback','fConfigGui(''ParallelProcessing'',getappdata(0,''hConfigGui''));','Value',0,...
                                          'Position',[.65 .05 .15 .4],'String','Use server:','Fontsize',12,'Tag','cParallelProcessing','HorizontalAlignment','left',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Use_FIESTA_server');  

hConfigGui.pGeneral.eServerName = uicontrol('Parent',hConfigGui.pGeneral.pOptions,'Style','edit','Units','normalized',...
                                         'Position',[.82 .05 .15 .4],'Tag','eServerName','Fontsize',10,'Enable','off',...
                                         'String','','BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Use_FIESTA_server');
                                     
if ~isempty(Config.TrackingServer)
    set(hConfigGui.pGeneral.cUseServer,'Value',1);
    set(hConfigGui.pGeneral.eServerName,'String',Config.TrackingServer,'Enable','on');
end
    
                                     
hConfigGui.pGeneral.pTrack = uipanel('Parent',hConfigGui.pGeneral.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pGeneral.tOnlyMol = uicontrol('Parent',hConfigGui.pGeneral.pTrack,'Style','text','Units','normalized',...
                                         'Position',[.05 .6 .3  .2],'Tag','tOnlyMol','Fontsize',12,'BackgroundColor',c,'ForegroundColor',ctext,...
                                         'String','Only Molecules:','HorizontalAlignment','left');        
                                     
hConfigGui.pGeneral.cMolFull = uicontrol('Parent',hConfigGui.pGeneral.pTrack,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized','Callback','fConfigGui(''OnlyTrack'',getappdata(0,''hConfigGui''));',...
                                         'Position',[.375 .6 .1 .2],'Tag','cMolFull','HorizontalAlignment','left','Value',Config.OnlyTrack.MolFull,...
...
hConfigGui.pGeneral.tOnlyFil = uicontrol('Parent',hConfigGui.pGeneral.pTrack,'Style','text','Units','normalized',...
                                         'Position',[.55 .6 .3  .2],'Tag','tOnlyFil ','Fontsize',12,...
                                         'String','Only Filaments:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                    
...
hConfigGui.pGeneral.cFilFull = uicontrol('Parent',hConfigGui.pGeneral.pTrack,'Style','checkbox','BackgroundColor',c,'Units','normalized','Callback','fConfigGui(''OnlyTrack'',getappdata(0,''hConfigGui''));',...
                                         'Position',[.875 .6 .1 .2],'Tag','cFilFull','HorizontalAlignment','left','Value',Config.OnlyTrack.FilFull,...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Tracking');  
                                     
hConfigGui.pGeneral.cIncludeFitData = uicontrol('Parent',hConfigGui.pGeneral.pTrack,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                                'Position',[.05 .2 .9 .2],'Fontsize',12,'String','Include fit data (Warning: aprox. 50x-100x data size)','Tag','cIncludeFitData','HorizontalAlignment','left','Value',Config.OnlyTrack.IncludeData,...
                                                'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Tracking');                                      
                                     
hConfigGui.pGeneral.pThreshold = uipanel('Parent',hConfigGui.pGeneral.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pGeneral.tAreaThreshold = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','text','Units','normalized',...
                                              ...
                                              'String','Area:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);              
...
hConfigGui.pGeneral.eAreaThreshold = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.Threshold.Area),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Area'); 
...
hConfigGui.pGeneral.tPix = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','text','Units','normalized',...
                                              ...
                                              'String','pixel','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);              
...
hConfigGui.pGeneral.rConstant = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                          ...
                                          'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Intensity');  
...
hConfigGui.pGeneral.rRelative = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
...
hConfigGui.pGeneral.rVariable = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
...
hConfigGui.pGeneral.tHeightThreshold = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','text','Units','normalized',...
                                              ...
                                              'String','Height:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);           
...
hConfigGui.pGeneral.eHeightThreshold = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.Threshold.Height),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Height');    
...
hConfigGui.pGeneral.tFitThreshold = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','text','Units','normalized',...
                                              ...
                                              'String','Fit(CoD):','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);           
...
hConfigGui.pGeneral.eFitThreshold = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.Threshold.Fit),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Fit_.28CoD.29');      
...
hConfigGui.pGeneral.tFWHM = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','text','Units','normalized',...
                                              ...
                                              'String','FWHM(Est.):','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                                                     
...
hConfigGui.pGeneral.eFWHM = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.Threshold.FWHM),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','FWHM_.28Estimate.29');                                          
...
hConfigGui.pGeneral.tNM(2) = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','text','Units','normalized',...
                                              ...
                                              'String','nm','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);              
...
hConfigGui.pGeneral.tBorderMargin = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','text','Units','normalized',...
                                              ...
                                              'String','Border Margin:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                                                     
...
hConfigGui.pGeneral.eBorderMargin = uicontrol('Parent',hConfigGui.pGeneral.pThreshold,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.BorderMargin),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Border_Margin');                                          
...
hConfigGui.pGeneral.pFilter = uipanel('Parent',hConfigGui.pGeneral.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pGeneral.rFilterNone = uicontrol('Parent',hConfigGui.pGeneral.pFilter,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                         ...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Filter_for_thresholding');          
...
hConfigGui.pGeneral.rFilterAverage = uicontrol('Parent',hConfigGui.pGeneral.pFilter,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
...
hConfigGui.pGeneral.rFilterSmooth = uicontrol('Parent',hConfigGui.pGeneral.pFilter,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                          'Position',[.475 .1 .2  .8],'Tag','rFilterSmooth','Fontsize',12,...
                                          'String','smooth after','HorizontalAlignment','left','Value',Value,...
                                          'Callback','fConfigGui(''SetFilter'',getappdata(0,''hConfigGui''));',...
                                          'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Filter_for_thresholding');    
                                      
hConfigGui.pGeneral.cFilterBackground = uicontrol('Parent',hConfigGui.pGeneral.pFilter,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
...
hConfigGui.pMolecules.panel = uipanel('Parent',hConfigGui.fig,'Units','normalized','Fontsize',12,'Bordertype','none',...
                                     'Position',[0 .06 1 0.54],'Tag','pNorm','Visible','on','BackgroundColor',c,'ForegroundColor',ctext);
...
hConfigGui.pMolecules.pConnect = uipanel('Parent',hConfigGui.pMolecules.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pMolecules.tMaxVelocity = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                         ...
                                         'String','max. Velocity:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             
...
hConfigGui.pMolecules.eMaxVelocity = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.ConnectMol.MaxVelocity),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Maximum_Velocity');                             
...
hConfigGui.pMolecules.tNMpS = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                    ...
                                    'String','nm/s','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);           
...
hConfigGui.pMolecules.tNumVerification = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                         ...
                                         'String','Verification Steps:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             
...
hConfigGui.pMolecules.eNumVerification = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.ConnectMol.NumberVerification),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Verification_Steps');                                   
...
hConfigGui.pMolecules.tWeightPosition = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                                    ...
                                                    'String','Position','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext); 
...
hConfigGui.pMolecules.tWeightDirection = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                                    ...
                                                    'String','Direction','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);  
...
hConfigGui.pMolecules.tWeightSpeed = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                                    ...
                                                    'String','Speed','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);  
...
hConfigGui.pMolecules.tWeightIntensity  = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                                    ...
                                                    'String','Intensity','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);   
...
hConfigGui.pMolecules.tWeights = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                                    ...
                                                    'String','Weights:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);    
...
hConfigGui.pMolecules.eWeightPos = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.ConnectMol.Position*100),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Weights');             
                                          
hConfigGui.pMolecules.tPercent(1) = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                              'Position',[.375 .25 .04  .18],'Tag','tPercent','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pMolecules.eWeightDir = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.ConnectMol.Direction*100),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Weights');      
...
hConfigGui.pMolecules.tPercent(2) = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                              ...
                                              'String','%','HorizontalAlignment','center','BackgroundColor',c,'ForegroundColor',ctext);                                              
...
hConfigGui.pMolecules.eWeightSpd = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.ConnectMol.Speed*100),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Weights');       
...
hConfigGui.pMolecules.eWeightInt = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.ConnectMol.IntensityOrLength*100),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center','Enable',enable,...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Weights');      
                                          
hConfigGui.pMolecules.tPercent(4) = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','text','Units','normalized',...
                                              'Position',[.95 .25 .04  .18],'Tag','tPercent','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
                                              'String','%','HorizontalAlignment','center','Enable',enable);  
                                          
hConfigGui.pMolecules.cActivateInt = uicontrol('Parent',hConfigGui.pMolecules.pConnect,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                              ...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Use_Intensity_.28only_molecules.29');       
                                          
hConfigGui.pMolecules.pTracks = uipanel('Parent',hConfigGui.pMolecules.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pMolecules.tMinLength = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','text','Units','normalized',...
                                         'Position',[.025 .7 .55  .2],'Tag','tMinLength','Fontsize',12,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pMolecules.eMinLength = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.ConnectMol.MinLength),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Minimum_Length');              
                                     
hConfigGui.pMolecules.tFramesMin = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','text','Units','normalized',...
                                         'Position',[.815 .69 .18  .2],'Tag','tFrames','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pMolecules.tMaxBreak = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','text','Units','normalized',...
                                         ...
                                         'String','Maximum Break:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             
...
hConfigGui.pMolecules.eMaxBreak = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.ConnectMol.MaxBreak),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Maximum_Break');  
                                     
hConfigGui.pMolecules.tFramesMax = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','text','Units','normalized',...
                                         'Position',[.815 .39 .18  .2],'Tag','tFrames','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
                                         'String','frames','HorizontalAlignment','left');                                        
...
hConfigGui.pMolecules.tMaxAngle = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','text','Units','normalized',...
                                         ...
                                         'String','Maximum Angle:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             
...
hConfigGui.pMolecules.eMaxAngle = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.ConnectMol.MaxAngle),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Maximum_Angle');                   
...
hConfigGui.pMolecules.tDeg = uicontrol('Parent',hConfigGui.pMolecules.pTracks,'Style','text','Units','normalized',...
                                         ...
                                         'String',char(176),'HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                                  
                                     
hConfigGui.pMolecules.pModel = uipanel('Parent',hConfigGui.pMolecules.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pMolecules.tMaxFunc = uicontrol('Parent',hConfigGui.pMolecules.pModel,'Style','text','Units','normalized',...
                                         'Position',[.025 .9 .3 .075],'Tag','tMaxFunc','Fontsize',12,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pMolecules.eMaxFunc = uicontrol('Parent',hConfigGui.pMolecules.pModel,'Style','edit','Units','normalized',...
                                         ...
                                         'String',num2str(Config.MaxFunc),'BackgroundColor',ctextbox,'ForegroundColor',ctext,...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,...
                                         'UserData','Tracking options#model',...
...
hConfigGui.pMolecules.tParams = uicontrol('Parent',hConfigGui.pMolecules.pModel,'Style','text','Units','normalized',...
                                         ...
                                         'String','Parameter:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                                 
...
hConfigGui.pMolecules.eParams = uicontrol('Parent',hConfigGui.pMolecules.pModel,'Style','text','Units','normalized',...
                                         ...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Model_.28only molecules.29');                                      
...
hConfigGui.pMolecules.mModel = uicontrol('Parent',hConfigGui.pMolecules.pModel,'Style','popupmenu','Units','normalized',...
                                          ...
                                          'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,...
                                          'UserData','Tracking options#model','BackgroundColor',ctextbox,'ForegroundColor',ctext);    
...
hConfigGui.pFilaments.panel = uipanel('Parent',hConfigGui.fig,'Units','normalized','Fontsize',12,'Bordertype','none',...
                                     'Position',[0 .06 1 0.54],'Tag','pNorm','Visible','off','BackgroundColor',c,'ForegroundColor',ctext);
...
hConfigGui.pFilaments.pConnect = uipanel('Parent',hConfigGui.pFilaments.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
                                       'Position',[0.025 0.65 .575 .25],'Tag','pConnect','Visible','on','Title','Connecting');                                            
...
hConfigGui.pFilaments.eMaxVelocity = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','edit','Units','normalized',...
                                         'Position',[.275 .7 .1  .2],'Tag','eMaxVelocity','Fontsize',10,...
                                         'String',num2str(Config.ConnectFil.MaxVelocity),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Maximum_Velocity');                                   

hConfigGui.pFilaments.tNMpS = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','text','Units','normalized',...
                                    'Position',[.380 .7 .1  .2],'Tag','tNMpS','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pFilaments.tNumVerification = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','text','Units','normalized',...
                                         'Position',[.5 .7 .325  .2],'Tag','tNumVerification','Fontsize',12,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pFilaments.eNumVerification = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','edit','Units','normalized',...
                                         'Position',[.85 .7 .1  .2],'Tag','eNumVerification','Fontsize',10,...
                                         'String',num2str(Config.ConnectFil.NumberVerification),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Verification_Steps');                                 
...
hConfigGui.pFilaments.eWeightPos = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','edit','Units','normalized',...
                                                ...
                                                'String',num2str(Config.ConnectFil.Position*100),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                                'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Weights');                                                          
...
hConfigGui.pFilaments.eWeightSpd = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.ConnectFil.Speed*100),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Weights');  
...
hConfigGui.pFilaments.eWeightLen = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','edit','Units','normalized',...
                                              ...
                                              'String',num2str(Config.ConnectFil.IntensityOrLength*100),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Weights');          
...
hConfigGui.pFilaments.cDisregardEdge = uicontrol('Parent',hConfigGui.pFilaments.pConnect,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                              ...
                                              'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Disregard_filaments_at_the_edge_of_the_field_of_view_.28only_filaments.29');      
                                          
hConfigGui.pFilaments.pTracks = uipanel('Parent',hConfigGui.pFilaments.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
                                        'Position',[0.65 0.65 .325 .25],'Tag','pConnect','Visible','on','Title','Tracks');      
...
hConfigGui.pFilaments.tMinLength = uicontrol('Parent',hConfigGui.pFilaments.pTracks,'Style','text','Units','normalized',...
                                         ...
                                         'String','Minimum Length:','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                             

hConfigGui.pFilaments.eMinLength = uicontrol('Parent',hConfigGui.pFilaments.pTracks,'Style','edit','Units','normalized',...
                                         'Position',[.6 .7 .2  .2],'Tag','eMinLength','Fontsize',10,...
                                         'String',num2str(Config.ConnectFil.MinLength),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                                'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Minimum_Length');     
...
hConfigGui.pFilaments.tFramesMin = uicontrol('Parent',hConfigGui.pFilaments.pTracks,'Style','text','Units','normalized',...
                                         ...
                                         'String','frames','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext);                                                                                                                                     
...
hConfigGui.pFilaments.eMaxBreak = uicontrol('Parent',hConfigGui.pFilaments.pTracks,'Style','edit','Units','normalized',...
                                         'Position',[.6 .4 .2  .2],'Tag','eMaxBreak','Fontsize',10,...
                                         'String',num2str(Config.ConnectFil.MaxBreak),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                                'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Maximum_Break');       
...
hConfigGui.pFilaments.eMaxAngle = uicontrol('Parent',hConfigGui.pFilaments.pTracks,'Style','edit','Units','normalized',...
                                         'Position',[.6 .1 .2  .2],'Tag','eMaxAngle','Fontsize',10,...
                                         'String',num2str(Config.ConnectFil.MaxAngle),'BackgroundColor',ctextbox,'ForegroundColor',ctext,'HorizontalAlignment','center',...
                                         'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Maximum_Angle');                   
...
hConfigGui.pFilaments.pRefPoint = uipanel('Parent',hConfigGui.pFilaments.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pRefPoint.rStart = uicontrol('Parent',hConfigGui.pFilaments.pRefPoint,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                        ...
                                        'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Reference_Point_.28only_filaments.29');               
...
hConfigGui.pRefPoint.rCenter = uicontrol('Parent',hConfigGui.pFilaments.pRefPoint,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
...
hConfigGui.pRefPoint.rEnd = uicontrol('Parent',hConfigGui.pFilaments.pRefPoint,'Style','radiobutton','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                        'Position',[.675 .2 .3  .6],'Tag','rEnd','Fontsize',12,...
                                        'String','End Point','HorizontalAlignment','left','Value',Value,...
                                        'Callback','fConfigGui(''SetRefPoint'',getappdata(0,''hConfigGui''));',...
                                        'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Reference_Point_.28only_filaments.29');     

hConfigGui.pFilaments.pExperimental = uipanel('Parent',hConfigGui.pFilaments.panel,'Units','normalized','Fontsize',10,'BackgroundColor',c,'ForegroundColor',ctext,...
...
hConfigGui.pFilaments.tExperimental = uicontrol('Parent',hConfigGui.pFilaments.pExperimental,'Style','text','Units','normalized',...
                                         ...
                                         'String','The following options are experimental and require more testing!','HorizontalAlignment','left','BackgroundColor',c,'ForegroundColor',ctext); 
                                         
hConfigGui.pExperimental.cFocus = uicontrol('Parent',hConfigGui.pFilaments.pExperimental,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                        ...
                                        'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Correct_for_focus_drift');   
                                    
hConfigGui.pExperimental.cCurvedFil = uicontrol('Parent',hConfigGui.pFilaments.pExperimental,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'Units','normalized',...
                                                'Position',[.025 .3 .55  .2],'Tag','cCurvedFil','Fontsize',10,...
                                                'String','Track especially curved filaments - reduce fit box size to:','HorizontalAlignment','left','Value',Config.ReduceFitBox<1,...
                                                'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Track_especially_curved_filaments');    
                                            
hConfigGui.pExperimental.eReduceFitBox = uicontrol('Parent',hConfigGui.pFilaments.pExperimental,'Style','edit','BackgroundColor',ctextbox,'ForegroundColor',ctext,'Units','normalized',...
...
hConfigGui.pExperimental.cDynamicFil = uicontrol('Parent',hConfigGui.pFilaments.pExperimental,'Style','checkbox','BackgroundColor',c,'ForegroundColor',ctext,'ForegroundColor',ctext,'Units','normalized',...
                                                ...
                                                'TooltipString','Right click for Help','UIContextMenu',hConfigGui.mHelpContext,'UserData','Track_dynamic_filaments');                                                  
                                                                                                                                                                                                            
hConfigGui.pButtons = uipanel('Parent',hConfigGui.fig,'Units','normalized','Fontsize',12,'Bordertype','none',...
                                     'Position',[0 0 1 0.06],'Tag','pNorm','Visible','on','BackgroundColor',c,'ForegroundColor',ctext);
...
hConfigGui.bApply = uicontrol('Parent',hConfigGui.pButtons,'Style','pushbutton','Units','normalized',...
                              ...
                              'BackgroundColor',cbutton,'ForegroundColor',ctext,...
...
if get(gcbo,'Value')==1
    ...
    elseif gcbo==hConfigGui.pGeneral.cFilFull
        if get(hConfigGui.pMolecules.mModel,'Value') == 4
            set(hConfigGui.pMolecules.mModel,'Value',1);
            fConfigGui('ShowModel',hConfigGui);
        end
...
global Config;
if gcbo == hConfigGui.pGeneral.cParallelProcessing
    value = get(hConfigGui.pGeneral.cParallelProcessing,'Value');
    if isempty(Config.NumCores) || Config.NumCores == 0
        if isempty(get(hConfigGui.pGeneral.eNumCores,'String'))
            str = ['max ' num2str(feature('numCores'))];
        else
            str = get(hConfigGui.pGeneral.eNumCores,'String');
        end
    else
        str = num2str(Config.NumCores);
    end
    if value == 1
        enable = 'on';
        uicontrol(hConfigGui.pGeneral.eNumCores);uicontrol(hConfigGui.pGeneral.eNumCores);
    else
        str = ['max ' num2str(feature('numCores'))];
        enable = 'off';
    end
    set(hConfigGui.pGeneral.eNumCores,'String',str,'Enable',enable);
else
    value = get(hConfigGui.pGeneral.cUseServer,'Value');
    if value == 1
        if isempty(Config.TrackingServer)
            if isempty(get(hConfigGui.pGeneral.eServerName,'String'))
                str = 'computer name';
            else
                str = get(hConfigGui.pGeneral.eServerName,'String');
            end
        else
            str = Config.TrackingServer;
        end
        enable = 'on';
        uicontrol(hConfigGui.pGeneral.eServerName);uicontrol(hConfigGui.pGeneral.eServerName);
    else
        str = '';
        enable = 'off';
    end
    set(hConfigGui.pGeneral.eServerName,'String',str,'Enable',enable);
end
...
if strcmp(get(hConfigGui.pGeneral.eTimeDiff,'Enable'),'on')
...
if get(hConfigGui.pGeneral.cParallelProcessing,'Value')==1
    cores = str2double(get(hConfigGui.pGeneral.eNumCores,'String'));
    if isnan(cores)
    ...
    tempConfig.NumCores = cores;
else
    tempConfig.NumCores = 0;
end

if get(hConfigGui.pGeneral.cUseServer,'Value')==1
...
switch(get(hConfigGui.pMolecules.mModel,'Value'))
    ...
    case 4
        ...
        tempConfig.MaxFunc = 0;
        tempConfig.OnlyTrack.MolFull = 1;
        tempConfig.OnlyTrack.FilFull = 0;
end

if strcmp(tempConfig.Model,'Diatom')==0
    tempConfig.MaxFunc=str2double(get(hConfigGui.pMolecules.eMaxFunc,'String'));
    if tempConfig.MaxFunc<1||isnan(tempConfig.MaxFunc)
...
if isempty(err)&&strcmp(warn,'continue')
    ...
    try
        ...
        if Config.NumCores > 0 
            fMsgDlg('Local Parallel Processing Toolbox not available','warn');
        end
        Config.NumCores = 0;
        p = [];
    end
    if Config.NumCores>0
        if isempty(p)
            progressdlg('Title','Progress Dialog','String','Activating Parallel Processing','Min',0,'Max',1,'Value',0,'Indeterminate','on');
            parpool('local',Config.NumCores,'IdleTimeout',Inf);
            progressdlg('close');
        else
            if p.NumWorkers~=Config.NumCores
                progressdlg('Title','Progress Dialog','String','Activating Parallel Processing','Min',0,'Max',1,'Value',0,'Indeterminate','on');
                delete(p);
                parpool('local',Config.NumCores,'IdleTimeout', Inf);
                progressdlg('close');
...
function Help
openhelp('Configuration',get(gco,'UserData'));
...
if n>=0
    ...
    switch(get(hConfigGui.pMolecules.mModel,'Value'))
        ...
        case 4
            ...
            equation='\(I(x,y) = \frac{h}{2\pi\sigma_x\sigma_x\sqrt{1-\rho^2}} \cdot \exp \left[-\frac{1}{(1-\rho^2)} \left( \frac{\left(x-\hat{x}\right)^2}{2\sigma^2_x} -\rho\,\frac{\left(x-\hat{x}\right)}{\sigma_x}\,\frac{\left(y-\hat{y}\right)}{\sigma_y}+ \frac{\left(y-\hat{y}\right)^2}{2\sigma^2_y}\right) \right]\)';
            Z=CalcDiatom(X,Y);   
            set(hConfigGui.pGeneral.cMolFull,'Value',1);
            set(hConfigGui.pGeneral.cFilFull,'Value',0);
    end
    choice = cell2mat(get(get(hConfigGui.pGeneral.pTrack,'Children'),'Value'));
    if choice(2) || choice(4)
    ...
    text('Parent',hConfigGui.pMolecules.aModelLabel,'Interpreter','latex','Position',[0.01 0.99],...
         'FontSize',14,'BackgroundColor',get(hConfigGui.pMolecules.pModel,'BackgroundColor'),'String',label,'VerticalAlignment','top','Color','white');
    if ~isempty(label2) 
    ...
    text('Parent',hConfigGui.pMolecules.aModelEquation,'Interpreter','latex','Position',[0.01 0.6],...
         'FontSize',16,'BackgroundColor',get(hConfigGui.pMolecules.pModel,'BackgroundColor'),'String',equation,'Color','white');
