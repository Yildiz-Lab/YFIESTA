...
hLeftPanel.pNorm.panel = uipanel('Parent',hMainGui.fig,'Units','normalized','Fontsize',12,'Bordertype','line',...
...
hLeftPanel.pNorm.tScaleMin = uicontrol('Parent',hLeftPanel.pNorm.panel,'Style','text','Units','normalized',...
                                       ...
                                       'String','min','HorizontalAlignment','left','Enable','inactive','BackgroundColor',c,'ForegroundColor','white');
...
hLeftPanel.pNorm.tScaleMax = uicontrol('Parent',hLeftPanel.pNorm.panel,'Style','text','Units','normalized',...
                                       ...
                                       'String','max','HorizontalAlignment','center','Enable','inactive','BackgroundColor',c,'ForegroundColor','white');
...
hLeftPanel.pNorm.eScaleMin = uicontrol('Parent',hLeftPanel.pNorm.panel,'Style','edit','Units','normalized',...
                                       ...
                                       'BackgroundColor',ctextbox,'ForegroundColor',ctext,'Enable','inactive',...
...
%create Thresh Panel
hLeftPanel.pThresh.panel = uipanel('Parent',hMainGui.fig,'Units','normalized','Fontsize',12,'Bordertype','line',...
...
hLeftPanel.pRedNorm.panel = uipanel('Parent',hMainGui.fig,'Units','normalized','Fontsize',12,'Bordertype','line',...
...
hLeftPanel.pGreenNorm.panel = uipanel('Parent',hMainGui.fig,'Units','normalized','Fontsize',12,'Bordertype','line',...
...
hLeftPanel.pRedThresh.panel = uipanel('Parent',hMainGui.fig,'Units','normalized','Fontsize',12,'Bordertype','line',...
...
hLeftPanel.pGreenThresh.panel = uipanel('Parent',hMainGui.fig,'Units','normalized','Fontsize',12,'Bordertype','line',...
...
%create Region Panel                      
hLeftPanel.pRegions.panel = uipanel('Parent',hMainGui.fig,'Units','normalized','Fontsize',12,'Bordertype','line',...
...
hLeftPanel.pRegions.tRegions = uicontrol('Parent',hLeftPanel.pRegions.panel,'Style','text','Units','normalized',...
            ...
            % JS Edit 2022/10/20 button to find automatic MT'esque regions
hLeftPanel.pRegions.ASSAMM = uicontrol('Parent',hLeftPanel.pRegions.panel,'Callback','fLeftPanel(''FindRegion'',getappdata(0,''hMainGui''));',...
                                       'Units','normalized','Style','pushbutton','Tag','pRegionsASSAM',...
                                       'FontSize',10,'FontWeight','normal',...                                             
                                       'Position',[.1 .84 .8 .075],'String','Find Regions',...
                                       'BackgroundColor',cbutton,'ForegroundColor',ctext);
            % End of JS Edit
                                     
hLeftPanel.pRegions.pRegListPan = uipanel('Parent',hLeftPanel.pRegions.panel,'Units','normalized','Bordertype','line',...
                                        'Position',[.05 .155 .9 .68],'Tag','pRegListPan','Visible','on','UIContextMenu',hMainGui.Menu.ctRegion,'BackgroundColor',c);
                                    
for i=1:8
    
    hLeftPanel.pRegions.RegList.Pan(i) = uipanel('Parent',hLeftPanel.pRegions.pRegListPan,'Units','normalized','Bordertype','line',...
...
hLeftPanel.pRegions.cExcludeReg = uicontrol('Parent',hLeftPanel.pRegions.panel ,'Style','checkbox','Units','normalized',...
                                          ...
                                          'Position',[.05 .095 .9 .06],'Tag','cIgnoreFil','Enable','inactive',...
                                          'Callback','fLeftPanel(''ExcludeRegions'',getappdata(0,''hMainGui''));',...
                                          'BackgroundColor',c,'ForegroundColor',ctext); 
...
hLeftPanel.pRegions.Load = uicontrol('Parent',hLeftPanel.pRegions.panel,'Callback','fLeftPanel(''LoadRegion'',getappdata(0,''hMainGui''));',...
                                       ...
                                       'FontSize',10,'FontWeight','normal',...                                             
                                       'Position',[.05 .005 .4 .075],'String','Load',...
                                       'BackgroundColor',c,'ForegroundColor',ctext);   
...
hLeftPanel.pRegions.Save = uicontrol('Parent',hLeftPanel.pRegions.panel,'Callback','fLeftPanel(''SaveRegion'',getappdata(0,''hMainGui''));',...
                                       ...
                                       'FontSize',10,'FontWeight','normal',...                                             
                                       'Position',[.55 .005 .4 .075],'String','Save',...
                                       'BackgroundColor',c,'ForegroundColor',ctext);                                            

% % Attempt to Change border colors: https://undocumentedmatlab.com/articles/customizing-uicontrol-border/
% hh = [hLeftPanel.pRegions.Save];
% for h = 1:length(hh)
% jEdit = findjobj(hh(h));  % get underlying Java reference
